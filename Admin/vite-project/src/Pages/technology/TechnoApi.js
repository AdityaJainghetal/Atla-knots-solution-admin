...
export const createTechApi = (data) => api.post("/api/technology/product/create", data);
...
export const updateTechApi = (id, data) => api.put(`/api/technology/product/update/${id}`, data);

export const deleteTechApi = (id) => api.delete(`/api/technology/product/delete/${id}`);
